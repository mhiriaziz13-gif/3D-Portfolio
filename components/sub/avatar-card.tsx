import { AvatarArtwork } from "@/components/sub/avatar-artwork";
...
export const AvatarCard = ({ profile = fallbackPortfolioContent.profile }: { profile?: ProfileContent }) => {
  return (
    <div
      className="relative mx-auto flex aspect-square w-full max-w-[25rem] items-center justify-center rounded-full border border-[#7042f88b] bg-[#120829]/70 shadow-[0_0_70px_rgba(112,66,248,0.28)] backdrop-blur-md motion-safe:animate-avatar-float"
